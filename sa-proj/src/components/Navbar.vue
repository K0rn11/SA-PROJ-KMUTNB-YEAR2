...
import { ChevronsDown, Menu, AlertCircle } from "lucide-vue-next";
...
const alertType = ref<"success" | "destructive">("success");
...
function handleSignOut() {
  ...
  alertMessage.value = "Signed out successfully!";
